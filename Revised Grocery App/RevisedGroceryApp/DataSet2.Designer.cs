...
namespace RevisedGroceryApp {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class itemsDataTable : global::System.Data.TypedTableBase<itemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public itemsRow AdditemsRow(string itemname, string itemcategory) {
...
namespace RevisedGroceryApp.DataSet2TableAdapters {
    ...
    public partial class itemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[items] WHERE (([itemid] = @Original_itemid) AND ([itemname] = " +
                "@Original_itemname) AND ([itemcategory] = @Original_itemcategory))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[items] SET [itemname] = @itemname, [itemcategory] = @itemcategory WHERE (([itemid] = @Original_itemid) AND ([itemname] = @Original_itemname) AND ([itemcategory] = @Original_itemcategory));
SELECT itemid, itemname, itemcategory FROM items WHERE (itemid = @itemid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT itemid, itemname, itemcategory FROM dbo.items";
        ...
        public virtual int Fill(DataSet2.itemsDataTable dataTable) {
        ...
        public virtual DataSet2.itemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet2.itemsDataTable dataTable = new DataSet2.itemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet2.itemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_itemid, string Original_itemname, string Original_itemcategory) {
        ...
        public virtual int Update(string itemname, string itemcategory, int Original_itemid, string Original_itemname, string Original_itemcategory, int itemid) {
            if ((itemname == null)) {
            ...
            if ((Original_itemcategory == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_itemcategory));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string itemname, string itemcategory, int Original_itemid, string Original_itemname, string Original_itemcategory) {
            return this.Update(itemname, itemcategory, Original_itemid, Original_itemname, Original_itemcategory, Original_itemid);
        }
    }
