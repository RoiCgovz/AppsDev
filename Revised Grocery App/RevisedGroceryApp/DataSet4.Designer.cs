...
namespace RevisedGroceryApp.DataSet4TableAdapters {
...
SELECT inventoryid, inv_itemid, inventorydate, inventorystock FROM inventory WHERE (inventoryid = @inventoryid)";
        ...
        public virtual int Fill(DataSet4.inventoryDataTable dataTable) {
        ...
        public virtual DataSet4.inventoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet4.inventoryDataTable dataTable = new DataSet4.inventoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet4.inventoryDataTable dataTable) {
